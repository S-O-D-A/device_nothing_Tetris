...
# Build chained vbmeta_system.img (required for A/B OTA if vbmeta_system is in AB_OTA_PARTITIONS)
...
# Build chained vbmeta_vendor.img (required if vbmeta_vendor is in AB_OTA_PARTITIONS)
